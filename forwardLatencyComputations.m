function [ forwardLatency, latencyArray, lastContactTimeArray, pathLengthArray ] = ...
    forwardLatencyComputations(node_i,node_j,time,contactSequence,directed,...
    contactTimes,nNodes)
...
while forwardLatency == 0 && t<=maxt
   ...
   forwardLatency = lastContactTimeArray(node_i,node_j,t);
