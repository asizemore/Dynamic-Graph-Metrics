function [ phi ] = informationView(node_i,node_j,time,contactSequence,...
...
% if isempty(phi)
%     fprintf('No time respecting path has yet existed from node %d to node %d.\n',...
%         node_j,node_i)
%     disp('Please choose a later time.')
% end
